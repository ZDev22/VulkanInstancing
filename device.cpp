...
namespace vulkan {
    ...
    void Device::createInstance() {
        ...
        appInfo.apiVersion = VK_API_VERSION_1_2; // Use Vulkan 1.2 for descriptor indexing
    ...
    void Device::createLogicalDevice() {
        ...
        // Update device extensions to include VK_EXT_descriptor_indexing
    ...
    void Device::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
        ...
        vkCmdCopyBuffer(commandBuffer, srcBuffer, dstBuffer, 1, &copyRegion); // Fixed typo
    ...
    void Device::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height, uint32_t layerCount) {
        ...
        vkCmdCopyBufferToImage(commandBuffer, buffer, image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &region); // Fixed typo
        endSingleTimeCommands(commandBuffer);
    }
